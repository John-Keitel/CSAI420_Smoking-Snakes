...
A skill for AI coding agents that helps create comprehensive Technical Design Documents (TDDs) following industry
standards.
...
- **Optional sections**: Success Metrics, Glossary, Alternatives Considered, Dependencies, Performance Requirements, and
  more
...
The TDD includes a metadata section for Epic/Ticket links. You can manually add these or ask the agent to help create
Jira tickets.
...
✅ **Includes**: API contracts, data schemas, architecture diagrams, strategies ❌ **Avoids**: CLI commands, code
snippets, framework-specific implementation
...
**This is normal!** The skill is designed to gather complete information. Answer the questions to get a comprehensive
TDD.
